...
from src.model.model_utils.model_encoder import BFeatRelObjConNet
...
class MmgnetFinetune(BaseModel):
    def __init__(self, config, num_obj_class, num_rel_class, dim_descriptor=11):
        ...
        self.frontend_3d = BFeatRelObjConNet(config, "cuda") 
        self.frontend_3d.load_state_dict(torch.load(config.train.ckp_path))
        self.frontend_3d = self.frontend_3d.eval()
    ...
    def forward(self, obj_points, obj_2d_feats, edge_indices, descriptor=None, batch_ids=None, istrain=False):
        ...
        obj_feature = _obj_feats.clone().detach()
        rel_feature_3d = _edge_feats.clone().detach()
        ...
        # obj_features_2d_mimic = obj_2d_feats.clone() # 768
        ...
        if istrain:
            return obj_logits_3d, obj_logits_2d, rel_cls_3d, rel_cls_2d, gcn_edge_feature_2d_dis, logit_scale
        else:
    ...
    def process_train(self, obj_points, obj_2d_feats, gt_cls, descriptor, gt_rel_cls, edge_indices, batch_ids=None, with_log=False, ignore_none_rel=False, weights_obj=None, weights_rel=None):
        ...
        obj_logits_3d, obj_logits_2d, rel_cls_3d, rel_cls_2d, edge_feature_2d, obj_logit_scale = self(obj_points, obj_2d_feats, edge_indices.t().contiguous(), descriptor, batch_ids, istrain=True)
