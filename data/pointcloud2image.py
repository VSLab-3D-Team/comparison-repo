...
if __name__ == '__main__':
    ...
    fin_all = open(os.path.join(f'/media/michael/ssd1/SceneGraph/3DSSG/3RScan/data/3RScan/{args.mode}_all_quanlity.txt'), 'a')
    for i in tqdm(selected_scans):
        ...
        save_path = f'/media/michael/ssd1/SceneGraph/3DSSG/3RScan/data/3RScan/{i}/multi_view'
        os.makedirs(save_path, exist_ok=True)
        # print(f'======= map pointcloud to image =========')
        class_list, class_weight = get_label('/media/michael/ssd1/SceneGraph/3DSSG/3DSSG_subset/classes.txt')
